...
export default function ProductPage() {
  ...
  const WA_MSG = encodeURIComponent(
    `Hi! I'm interested in "${product.name}" (Size: ${selSize || 'TBD'}, ₹${product.price?.toLocaleString('en-IN')}) from your Summer 2025 collection. Is it available? 🌸`
  );
    ...
    <div className="min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="px-5 md:px-10 py-8 md:py-10 flex flex-col">
          ...
          <Link href={`/try-on`}
            className="w-full border border-[#e5e5e5] hover:border-black text-black text-[11px] tracking-[0.22em] uppercase py-3.5 mb-3 transition-all flex items-center justify-center gap-2">
          ...
          {/* WhatsApp order */}
          <a href={`https://wa.me/918980008826?text=${WA_MSG}`} target="_blank" rel="noopener noreferrer"
